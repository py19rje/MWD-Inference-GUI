...
class HelpDialog(QDialog):
    ...
    def preprocess_readme(self, lines):
        ...
        processed_lines.append("6. (Required) Select NN models to make prediction. Make sure the correct class of MWD is selected in the dropdown 'Select MWD Class for Prediction'. Then press 'Select NN Model', and a dialog will appear with a menu of the available models. Select one or more and press 'ok'. This will load each model choice into the software and make them ready for prediction. Note that different models will produce slightly different results as NN training is not deterministic. Try making multiple predictions to see how similar they are!\n\n")
        processed_lines.append("7. (Required) Make a prediction using the 'Make Prediction' function button. This will display the prediction of each loaded NN on the 'MWD' plot.\n\n")
        ...
        processed_lines.append("9. (Optional) Save a prediction using the 'Save Prediction' function button. This will open a file save dialog where you can select the location and name of the file to save. You can also choose whether you would like to save the tails-corrected or original prediction.\n\n")
